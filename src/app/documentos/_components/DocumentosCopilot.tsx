...
export function DocumentosCopilot({
  ...
  return (
    <section className="h-full overflow-hidden rounded-3xl border border-slate-200 bg-[linear-gradient(180deg,rgba(15,23,42,0.98),rgba(15,23,42,0.92))] text-white shadow-2xl shadow-slate-900/10 xl:h-full xl:w-full xl:max-h-[calc(100vh-3rem)] xl:overflow-y-auto xl:overscroll-contain">
        ...
        {collapsed ? (
          <div className="flex items-center justify-center">
            <button
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/15 text-slate-200 transition hover:bg-white/5"
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={onToggleCollapsed}
              className="inline-flex items-center gap-2 rounded-full border border-white/15 px-3 py-2 text-xs font-semibold text-slate-200 transition hover:bg-white/5"
              aria-label="Recolher copilot"
              title="Recolher copilot"
            >
      ...
      {collapsed ? (
        <div className="flex min-h-[260px] flex-col items-center justify-between px-4 py-5 text-center">
          <div className="flex flex-col items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-cyan-400/20 bg-cyan-400/10">
              <Bot className="h-5 w-5 text-cyan-200" />
            </div>
            <div className="[writing-mode:vertical-rl] rotate-180 text-[10px] font-semibold uppercase tracking-[0.35em] text-slate-300">
              Copilot
            </div>
          </div>
          <button
            type="button"
            onClick={onToggleCollapsed}
            className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-cyan-400 text-slate-950 transition hover:bg-cyan-300"
            aria-label="Abrir copilot"
            title="Abrir copilot"
          >
