  ...
  if (submitResult === "ok") {
    return (
      <div className="flex flex-col items-center gap-4 py-10 text-center">
        ...
        <div className="mx-2 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-left text-xs leading-5 text-amber-800">
          <p className="mb-1 font-semibold">Último passo — validação no BTracker</p>
          A nota entrou <strong>pré-preenchida</strong> e fica como{" "}
          <strong>“Bloqueado”</strong> até ser validada. Isso é normal: o BTracker
          exige a validação manual. Abra a nota no BTracker e clique em{" "}
          <strong>validar/liberar</strong> para concluir.
        </div>
        <div className="flex gap-2">
          ...
          >
            <ExternalLink className="h-3.5 w-3.5" /> Validar no BTracker
          </a>
          <button
            type="button"
            onClick={onReset}
